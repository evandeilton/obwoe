...
// corrCpp
Rcpp::List corrCpp(SEXP x, std::string method, std::string use, int min_periods);
RcppExport SEXP _obwoe_corrCpp(SEXP xSEXP, SEXP methodSEXP, SEXP useSEXP, SEXP min_periodsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(corrCpp(x, method, use, min_periods));
    return rcpp_result_gen;
END_RCPP
}
// dmiv_woe
...
// meansCpp
Rcpp::DataFrame meansCpp(Rcpp::DataFrame data, Rcpp::Nullable<Rcpp::CharacterVector> var_vars, Rcpp::Nullable<Rcpp::CharacterVector> class_vars, Rcpp::CharacterVector statistics, std::string vardef, Rcpp::Nullable<Rcpp::String> weight_var, Rcpp::Nullable<Rcpp::String> freq_var, double alpha);
RcppExport SEXP _obwoe_meansCpp(SEXP dataSEXP, SEXP var_varsSEXP, SEXP class_varsSEXP, SEXP statisticsSEXP, SEXP vardefSEXP, SEXP weight_varSEXP, SEXP freq_varSEXP, SEXP alphaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterVector> >::type var_vars(var_varsSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterVector> >::type class_vars(class_varsSEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type statistics(statisticsSEXP);
    Rcpp::traits::input_parameter< std::string >::type vardef(vardefSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::String> >::type weight_var(weight_varSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::String> >::type freq_var(freq_varSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    rcpp_result_gen = Rcpp::wrap(meansCpp(data, var_vars, class_vars, statistics, vardef, weight_var, freq_var, alpha));
    return rcpp_result_gen;
END_RCPP
}
// cart_woe
...
// univariateCpp
Rcpp::List univariateCpp(Rcpp::DataFrame data, Rcpp::Nullable<Rcpp::CharacterVector> var_vars, Rcpp::Nullable<Rcpp::CharacterVector> class_vars, std::string vardef, int pctldef, double alpha, double trim);
RcppExport SEXP _obwoe_univariateCpp(SEXP dataSEXP, SEXP var_varsSEXP, SEXP class_varsSEXP, SEXP vardefSEXP, SEXP pctldefSEXP, SEXP alphaSEXP, SEXP trimSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type data(dataSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterVector> >::type class_vars(class_varsSEXP);
    Rcpp::traits::input_parameter< std::string >::type vardef(vardefSEXP);
    Rcpp::traits::input_parameter< int >::type pctldef(pctldefSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< double >::type trim(trimSEXP);
    rcpp_result_gen = Rcpp::wrap(univariateCpp(data, var_vars, class_vars, vardef, pctldef, alpha, trim));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_obwoe_corrCpp", (DL_FUNC) &_obwoe_corrCpp, 4},
    {"_obwoe_dmiv_woe", (DL_FUNC) &_obwoe_dmiv_woe, 30},
    {"_obwoe_meansCpp", (DL_FUNC) &_obwoe_meansCpp, 8},
    {"_obwoe_cart_woe", (DL_FUNC) &_obwoe_cart_woe, 22},
    {"_obwoe_univariateCpp", (DL_FUNC) &_obwoe_univariateCpp, 7},
    {NULL, NULL, 0}
};
